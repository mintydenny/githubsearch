            ...
            return (
                <section className="github-profile">
                    <div className="github-profile-info">
                        ...
                        <h2>
                            <a href={userdata.homeURL} title={userdata.username} target="_blank">
                        ...
                        <ul>
                            <li>
                                <a href={followers} target="_blank" title="Number Of Followers">
                                    <i>{userdata.followers}</i> <span>Followers</span>
                                </a>
                            </li>
                            <li>
                                <a href={repos} target="_blank" title="Number Of Repos">
                                    <i>{userdata.repos}</i> <span>Repos</span>
                                </a>
                            </li>
                            <li>
                                <a href={following} target="_blank" title="Number Of Following">
                                    <i>{userdata.following}</i> <span>Following</span>
                                </a>
                            </li>
                        </ul>
                    </div>
